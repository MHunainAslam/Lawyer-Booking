   ...
   <body>
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <!-- <img src="assets/img/about/businessman-reading-contract-closeup_1098-14742.webp" alt=""> -->
    ...
    <main>
        ...
        <div class="slider-area ">
            <!-- Mobile Menu -->
            <div class="single-slider slider-height2 d-flex align-items-center" data-background="assets/img/about/businessman-reading-contract-closeup_1098-14742.webp">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-12">
