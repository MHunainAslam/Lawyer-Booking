 ...
 <div class="legal-practice-area section-padding30" style="margin-top: -100px;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <?php
                     $getlocationID = $_GET["gelawsp"];
                    $fetchdoc = mysqli_query($con, "SELECT * FROM lawyer
                    INNER JOIN location
                    on
                    location.L_Id = lawyer.location_id where location_id ='$getlocationID'");
                    while ($row = mysqli_fetch_array($fetchdoc)) {
                        echo '
                            ...
                            <?php 
                                ...
                                <a href="bookoppointment.php?fetchdoc='. $row[0] .'? > "><button class="submit-btn2" type="submit">Book Now</button></a>
                                </div>
                                </div>
                                        ';
                                    }
