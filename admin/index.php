<?php 
  ...
  session_start();
  if(isset($_SESSION["AdminEmails"])==null)
  {
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic1" aria-expanded="false" aria-controls="ui-basic">
              ...
              <span class="menu-title">Specilization</span>
              <i class="menu-arrow"></i>
            </a>
            <div class="collapse" id="ui-basic1">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"><a class="nav-link" href="index.php?getSpezialtion">Create</a></li>
                <li class="nav-item"><a class="nav-link" href="index.php?ViewSpecilization">View</a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic2">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="index.php?getLocation">Create</a></li>
                <li class="nav-item"> <a class="nav-link" href="index.php?ViewLocation">View</a></li>
          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="ui-basic4">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="index.php?addlawyer">Create</a></li>
                <li class="nav-item"> <a class="nav-link" href="index.php?viewLawyer">View</a></li>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <?php 
              ...
              else if(isset($_GET["viewLawyer"]))
              {
                include("viewlawyer.php");
              }
